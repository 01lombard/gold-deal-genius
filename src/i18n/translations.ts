  ...
  ru: {
    ...
    calculators: {
      ...
      interest: {
        ...
        info: {
          title: "ℹ️ Важная информация:",
          point1: "• Гарантийный срок 30 дней по 0.25%",
          point2: "• До 100 000 ₸: 0.25% в день",
          point3: "• Свыше 100 000 ₸: 0.19% в день",
          point4: "• Досрочное погашение без штрафов",
          point5: "• Продление займа возможно",
        },
      },
    },
    services: {
  ...
  kk: {
    ...
    calculators: {
      ...
      interest: {
        ...
        info: {
          title: "ℹ️ Маңызды ақпарат:",
          point1: "• Кепілдік мерзімі 30 күн 0.25% бойынша",
          point2: "• 100 000 ₸ дейін: күніне 0.25%",
          point3: "• 100 000 ₸ астам: күніне 0.19%",
          point4: "• Мерзімінен бұрын өтеу айыппұлсыз",
          point5: "• Қарызды ұзарту мүмкін",
        },
      },
    },
    services: {
